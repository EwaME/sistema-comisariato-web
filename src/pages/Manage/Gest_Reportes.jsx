    ...
    return (
        ...
        <div className="p-4 md:p-8 max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                <div>
                    <h2 className="text-2xl font-extrabold text-[#020817]">Gestión de Reportes</h2>
                    <p className="text-[13px] text-gray-500 mt-1 font-medium">
                        Administra los reportes y estadísticas de la empresa.
                    </p>
                </div>
            ...
            <div className="bg-white p-6 md:p-10 rounded-[1.5rem] shadow-[0_2px_20px_rgb(0,0,0,0.03)] border border-gray-50 min-h-[60vh] flex items-center justify-center">
                ...
                <div className="text-center">
                    <p className="text-gray-400 font-bold tracking-widest uppercase text-sm">
                        Módulo de Reportes en Construcción 🛠️
                    </p>
                    <p className="text-xs text-gray-300 mt-2">
                        Aquí irá la tabla con la lista de reportes.
                    </p>
                </div>
