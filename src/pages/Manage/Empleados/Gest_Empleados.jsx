...
export default function Empleados() {
  ...
  const empleadosFiltrados = empleados.filter((emp) => {
    ...
    const matchBusqueda =
      emp.id?.toLowerCase().includes(termino) ||
      nombreCompleto.includes(termino);

    const matchDepto =
      filtrosAplicados.departamento === "" ||
      emp.departamento === filtrosAplicados.departamento;

    const matchEstado =
      filtrosAplicados.estado === "" || emp.estado === filtrosAplicados.estado;
  ...
  const isFiltroActivo =
    filtrosAplicados.departamento !== "" || filtrosAplicados.estado !== "";
  ...
  return (
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100">
          <div className="text-right">
            ...
            <p className="text-lg font-extrabold text-[#020817] leading-none">
              {
                empleados.filter((e) => e.estado?.toUpperCase() === "ACTIVO")
                  .length
              }
      ...
      <div className="bg-white p-6 rounded-[1.5rem] shadow-[0_2px_20px_rgb(0,0,0,0.02)] border border-gray-2000 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          ...
          <div className="flex gap-3 w-full md:w-auto relative">
            ...
            <Link
              to="/empleados/nuevo"
              className="bg-[#020817] text-white text-[11px] font-bold px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 hover:bg-black transition-colors shadow-md w-full md:w-auto"
            >
              NUEVO EMPLEADO
            </Link>
          </div>
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-gray-400 font-medium">
                              {emp.correo || emp.correoContacto || "Sin correo"}
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4 font-bold text-[#020817]">
                        L
                        {(emp.limiteCredito || 0).toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                      <td className="py-4 px-4">
                        <span
                          className={`text-[9px] font-bold px-3 py-1.5 rounded-full uppercase tracking-wider ${
                            activo
        ...
        {!cargando && empleadosFiltrados.length > 0 && (
          <div className="flex flex-col sm:flex-row items-center justify-between mt-6 pt-4 border-t border-gray-50 gap-4">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
              ...
              {Math.min(startIndex + itemsPorPagina, empleadosFiltrados.length)}{" "}
              de {empleadosFiltrados.length} Resultados
            </p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#020817]/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-[1.5rem] shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
            <div className="bg-red-50 p-6 flex flex-col items-center border-b border-red-100 relative">
              ...
              <h3 className="text-lg font-extrabold text-red-600 text-center">
                ¿Inhabilitar a {empleadoSeleccionado.nombres}?
              </h3>
              <p className="text-xs font-medium text-red-500 mt-1 text-center px-4">
                Esta acción revocará el acceso del empleado al sistema y hará un
                cobro total de todos los créditos activos.
              </p>
            </div>
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <button
                  ...
                  disabled={
                    inputConfirmacion !== empleadoSeleccionado.id ||
                    desactivando
                  }
