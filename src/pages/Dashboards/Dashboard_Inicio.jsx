            ...
            <div className="flex-1 bg-white p-6 rounded-3xl shadow-[0_2px_20px_rgb(0,0,0,0.02)] border border-gray-50 flex flex-col">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    Visualización de desembolsos industriales 2026
                  </p>
                </div>
              ...
              <div className="flex-1 w-full h-48 relative mt-auto">
                ...
                >
                  ...
                  {/* Curva Suave */}
                  <path
                    d="M0,35 Q15,35 25,25 T50,15 T75,5 T100,5 L100,40 L0,40 Z"
                    fill="url(#gradient)"
                  />
                  <path
                    d="M0,35 Q15,35 25,25 T50,15 T75,5 T100,5"
                    fill="none"
                    stroke="#7C3AED"
                    strokeWidth="1"
                  />
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-100 rounded-full h-2">
                    <div
                      className="bg-[#020817] h-2 rounded-full"
                      style={{ width: "65%" }}
                    ></div>
                  </div>
                </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm font-medium text-[#020817]">
                  ...
                  <tr className="border-b border-gray-50 hover:bg-gray-50/50">
                    <td className="py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-purple-100 text-[#7C3AED] flex items-center justify-center text-xs font-bold">
                          JR
                        </div>
                  ...
                  <tr className="hover:bg-gray-50/50">
                    ...
                    <td className="py-4 text-right">
                      <span className="bg-yellow-100 text-yellow-700 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                        Pendiente
                      </span>
                    </td>
                  </tr>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <h4 className="text-sm font-bold text-[#020817]">
                    Carlos Ramírez
                  </h4>
                  <MoreVertical className="w-4 h-4 text-gray-400 cursor-pointer" />
                </div>
                <p className="text-xs text-gray-500 mt-1">
                  Realizó un pago de crédito
                </p>
