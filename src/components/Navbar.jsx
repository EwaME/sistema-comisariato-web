...
export default function Navbar({ setIsMobileOpen }) {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !navProfileMenuRef.current.contains(event.target)
      ) {
        setShowLogout(false);
      }
    };
  ...
  return (
    <div className="mx-3 mt-3 bg-white backdrop-blur-xl border border-gray-200 rounded-xl h-16 px-4 md:px-6 flex items-center justify-between sticky top-3 z-30">
